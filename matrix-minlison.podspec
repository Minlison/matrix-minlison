...
Pod::Spec.new do |matrix|
  ...
  matrix.source           = { :git => 'https://github.com/Minlison/matrix-minlison.git', :tag => "v#{matrix.version}" }
  ...
  matrix.subspec 'matrixNonARC2' do |non_arc2|
    ...
    non_arc2.dependency 'matrix-minlison/matrixARC'
  end
